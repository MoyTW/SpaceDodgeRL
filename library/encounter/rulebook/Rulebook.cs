...
public static class Rulebook {
  ...
  private static Dictionary<ActionType, Action<EncounterAction, EncounterState>> _actionMapping = new Dictionary<ActionType, Action<EncounterAction, EncounterState>>() {
    { ActionType.MOVE, (EncounterAction a, EncounterState s) => ResolveMove(a as MoveAction, s) },
    { ActionType.END_TURN, (EncounterAction a, EncounterState s) => ResolveEndTurn(a as EndTurnAction, s) }
  };
