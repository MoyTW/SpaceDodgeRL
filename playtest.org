...
+ TODO: If a fighter moves into you and fires you don't see any visible feedback even on high turn times!
  - Funny...it certainly has multiple frames.
+ TODO: High turn times introduce noticable input lag, even when they shouldn't.

** TODO: Issue: 'instant' projectile creation & destruction
