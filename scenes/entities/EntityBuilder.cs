...
namespace SpaceDodgeRL.scenes.entities {
  ...
  public static class EntityBuilder {
    ...
    private static Entity CreateExtraBatteryEntity() {
      ...
      e.AddComponent(DisplayComponent.Create(_texBatteryPath, "An extra battery for your weapons. Gives 20 power for 450 ticks.", true));
    ...
    private static Entity CreateDuctTapeEntity() {
      ...
      e.AddComponent(DisplayComponent.Create(_texDuctTapePath, "Some duct tape. Heals 10 HP.", true));
      e.AddComponent(StorableComponent.Create());
      e.AddComponent(UsableComponent.Create(useOnGet: false));
    ...
    public static Entity CreateIntelEntity(int targetDungeonLevel) {
      ...
      e.AddComponent(DisplayComponent.Create(_texIntelPath, "Intel! Gives you zone information for the next sector. You want this.", true));
      e.AddComponent(StorableComponent.Create());
